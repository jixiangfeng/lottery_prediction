...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output", default="reports/retrospective/ssq_d8_official_backtest_v1.json"
    )
    args = parser.parse_args(argv)
    try:
        report = evaluate_d8_official_backtest(
        ...
        print(f"D8官方逐票结算失败：{error}")
        return 1
    print("D8官方逐票结算完成，状态=uniform_abstain。")
    return 0

...
.PHONY: setup fmt lint test build run digit-fetch digit-reconcile-jsonl digit-predict-today three-layer-acceptance digit-predictability-audit digit-online-gradient digit-model-scoreboard digit-learned-ranker-train digit-learned-ranker-adaptive digit-learned-ranker-evaluate digit-learned-ranker-daily ci clean help
.DEFAULT_GOAL := help

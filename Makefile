...
.PHONY: setup fmt lint test build run train-graph download-data daily walk-forward-kl8 digit-report h5-install h5-sync h5-dev h5-build h5-test ci clean help
.DEFAULT_GOAL := help
